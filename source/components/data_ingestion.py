...
from source.components.data_transformation import DataTransformationConfigurations, DataTransformation
...
if __name__ == '__main__':
    ...
    data_transformation.initiate_data_transformation(train_dataset, test_dataset)